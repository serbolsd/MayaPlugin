...
//
//
//class JDExport : public MPxFileTranslator {
//public:
//  JDExport() {};
//  virtual         ~JDExport() {};
//  static void* creator();
...
//};
//const char* const objOptionScript = "JDExportOptions";
...
//}
//
//MStatus JDExport::OutputPolygons(
//  MDagPath& mdagPath,
//  MObject& mComponent
//)
//{
...
//}
//
//void* JDExport::creator()
//{
//  return new JDExport();
//}
//
//void JDExport::outputSetsAndGroups(
//  MDagPath& mdagPath,
//  int cid,
...
//}
//
//void JDExport::initializeSetsAndLookupTables(bool exportAll)
////
//// Description :
...
//
//
//void JDExport::freeLookupTables()
////
...
//}
//
//bool JDExport::lookup(MDagPath& dagPath,
//  int setIndex,
//  int compIdx,
//  bool isVtxIter)
//{
...
//}
//
//void JDExport::recFindTransformDAGNodes(MString& nodeName, MIntArray& transformNodeIndicesArray)
//{
...
//}
//
//MStatus JDExport::writer(const MFileObject& file,
//  const MString& optionsString,
//  FileAccessMode mode)
//{
//  MStatus status;
//
//  MString mname = "test.objd", unitName;
//
//
//#if defined (OSMac_)
...
//  smoothing = false; // write out facet smoothing information
...
//}
//
//void JDExport::buildEdgeTable(MDagPath& mesh)
//{
//  if (!smoothing)
//    return;
//
...
//}
//
//void JDExport::destroyEdgeTable()
////
...
//}
//
//void JDExport::addEdgeInfo(int v1, int v2, bool smooth)
////
...
//}
//
//EdgeInfoPtr JDExport::findEdgeInfo(int v1, int v2)
////
...
//}
//
//bool JDExport::smoothingAlgorithm(int polyId, MFnMesh& fnMesh)
//{
